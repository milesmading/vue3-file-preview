...
| 文件格式 | 扩展名 | 渲染驱动 | 功能支持 |
| :--- | :--- | :--- | :--- |
| **Microsoft Word** | `.docx` | `docx-preview` | 支持复杂排版、标题、列表、段落样式渲染 |
| **Microsoft Excel** | `.xlsx`, `.xls` | `xlsx` | 支持多 Sheet 工作表切换、高对比度表格视图 |
| **Microsoft PowerPoint**| `.pptx` | `JSZip` + XML | 支持多页 Slide 切换、键盘左右方向键 `➔` 翻页 |
